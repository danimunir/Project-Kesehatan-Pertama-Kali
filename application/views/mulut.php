...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<p align="center" style="font-family: Verdana; font-size: xx-large; margin-top: 100px;">Mulut</p>

		
		<table align="center" cellspacing="50" cellpadding="30">

		<tr>
		<td onclick="document.location = '<?php echo base_url().'sehatkontrol/mulut1'; ?>';">	
				<div class="card-group card border-secondary mb-3" style="max-width: 540px;">
								<div class="row g-0">
									<div class="col-md-8">
									<div class="card-body">
										<h5 class="card-title">Artikel 1<br><br><a class="stretched-link" href="<?php echo base_url().'sehatkontrol/mulut1'; ?>" style="text-decoration: none; color: black;">Definisi Mulut</a></h5>
										
									</div>
									</div>
								</div>
								</div>		
								<td onclick="document.location = '<?php echo base_url().'sehatkontrol/mulut2'; ?>';">	
				<div class="card-group card border-secondary mb-3" style="max-width: 340px;">
								<div class="row g-0">
									<div class="col-md-8">
									<div class="card-body">
										<h5 class="card-title">Artikel 2 <br><br><a class="stretched-link" href="<?php echo base_url().'sehatkontrol/mulut2'; ?>" style="text-decoration: none; color: black;">Jenis-Jenis Penyakit Mulut Dan Cara Menghindarinya</a></h5>
